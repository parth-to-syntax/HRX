...
export async function publicSignup(req, res) {
  try {
    const { first_name, last_name, email, company_id, date_of_joining } = req.body || {};
    ...
    try {
      ...
      await client.query(
        'INSERT INTO employees (user_id, company_id, first_name, last_name, email, date_of_joining, joining_serial) VALUES ($1,$2,$3,$4,$5,$6,$7)',
        [userId, company_id, first_name, last_name, email, date_of_joining, joining_serial]
      );
      await client.query('COMMIT');
