...
router.patch('/payslips/:id/validate', authRequired, rolesAllowed('admin','payroll'), validatePayslip);
router.patch('/payslips/:id/cancel', authRequired, rolesAllowed('admin','payroll'), cancelPayslip);
router.patch('/payslips/:id/recompute', authRequired, rolesAllowed('admin','payroll'), recomputePayslip);
...
// Reports
router.get('/reports/employer-cost', authRequired, rolesAllowed('admin','payroll'), monthlyEmployerCost);
router.get('/reports/employee-count', authRequired, rolesAllowed('admin','payroll'), monthlyEmployeeCount);
